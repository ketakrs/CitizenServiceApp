...
public class ImageUtils extends AppCompatActivity{
   ...
   */
//  public  void saveBitmap(final Bitmap bitmap) throws IOException {
//    saveBitmap(bitmap, "preview.JPEG", "","" );
//  }
   ...
   */
  public void saveBitmap(final Bitmap bitmap, final String filename,final float lat,final float lng) throws IOException{
    final String myDir =
            Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + ".CSPimg";
    final String txtDir =
            Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + ".CSPloc";



    LOGGER.i("Saving %dx%d bitmap to %s.", bitmap.getWidth(), bitmap.getHeight(), myDir);
//    ContextWrapper wrapper = new ContextWrapper(getApplicationContext());
//    File myDir = getFilesDir();
//    File myDir = getDir(Environment.DIRECTORY_PICTURES, Context.MODE_PRIVATE);
//    String myDir = Environment.getDataDirectory().getAbsolutePath()+File.separator+"NewCspApp";
...
//    if (!myDir.exists()) {
//      if (!myDir.mkdirs()) {
//        LOGGER.i("Failed to create storage directory.");
//      }
//    }

//    if (myDir!=null){
//      Toast.makeText(ImageUtils.this,"Null value",Toast.LENGTH_SHORT).show();
//    }else {
...
//    ExifInterface exif = new ExifInterface(myDir);
...
//
//    exif.saveAttributes();
//    Toast.makeText(ImageUtils.this,"Latitude: " + exif.getAttribute(ExifInterface.TAG_GPS_LATITUDE),Toast.LENGTH_SHORT).show();
